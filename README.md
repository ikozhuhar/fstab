...
[Как ядро Linux работает с жесткими дисками?](#1)
[Что такое fdisk?](#2)
[Как вывести список доступных дисков с помощью команды fdisk?](#3)
[Как вывести список определенных разделов диска с помощью команды fdisk?](#4)
[Как вывести список доступных действий для команды fdisk?](#5)
[Как вывести список типов разделов с помощью команды fdisk?](#6)
[Как создать раздел на диске с помощью команды fdisk?](#7)
[Как создать расширенный раздел диска с помощью команды fdisk?](#8)
[Как просмотреть нераспределенное место на диске с помощью команды fdisk?](#9)
[Как создать логический раздел с помощью команды fdisk?](#10)
[Как удалить раздел с помощью команды fdisk?](#11)
[Как отформатировать раздел или создать файловую систему на разделе?](#12)
[Как смонтировать раздел в Linux?](#13)
...
## Как просмотреть нераспределенное место на диске с помощью команды fdisk?
